...
### H
  ...
  * **[HarfBuzz (libharfbuzz.so) 11.2.1](harfbuzz.md)<a id='harfbuzz'></a>**<br>
...
### L
  ...
  * **[libffi (libffi.so) 3.5.1](libffi.md)<a id='libffi'></a>**<br>
  ...
  * **[libpng: PNG library (libpng.so) 1.6.48](libpng.md)<a id='libpng'></a>**<br>
...
### M
  ...
  * **[mbedtls: mbedCrypto (libmbedcrypto.so) 2.7.19/2.28.10/3.6.3.1](mbedtls.md)<a id='mbedtls'></a>**<br>
...
### R
  ...
  * **[readline: libreadline (libreadline.so) $(if $(FREETZ_LIB_libreadline_VERSION_ABANDON),6.3,8.2)](readline.md)<a id='readline'></a>**<br>
