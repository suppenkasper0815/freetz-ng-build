$(call PKG_INIT_LIB, $(if $(FREETZ_TARGET_GCC_5_1_MAX),2.49,2.75))
...
$(PKG)_HASH:=$($(PKG)_HASH_$(if $(FREETZ_TARGET_GCC_5_1_MAX),ABANDON,CURRENT))
...
$(PKG)_CONDITIONAL_PATCHES+=$(if $(FREETZ_TARGET_GCC_5_1_MAX),abandon,current)
