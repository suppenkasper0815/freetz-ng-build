$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_09),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_10),1.0.2u,$(if $(FREETZ_OPENSSL_VERSION_11),1.1.1w,$(if $(FREETZ_OPENSSL_VERSION_30),3.0.17,3.5.1)))))
...
$(PKG)_HASH_3.5:=529043b15cffa5f36077a4d0af83f3de399807181d607441d734196d889b641f
